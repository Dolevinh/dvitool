import requests, json, base64, os, uuid, re, sys
...
[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[1;32m[•] TOOL TDS FACEBOOK 100% VIP 👑
...
def Delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''{trang}[{lam}DVI{trang}] [{lam}DELAY{trang}] [{lam}{str(value)[0:5]}{trang}] [{vang}X    {trang}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{trang}[{lam}DVI{trang}] [{lam}DELAY{trang}] [{lam}{str(value)[0:5]}{trang}] [ {vang}X   {trang}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{trang}[{lam}DVI{trang}] [{lam}DELAY{trang}] [{lam}{str(value)[0:5]}{trang}] [  {vang}X  {trang}]''', '               ', end = '\r')
